...
factClassCallsMethod(class(2), function(5)).
factClassCallsMethod(class(2), function(8)).
factClassCallsMethod(class(2), function(9)).
factClassCallsMethod(class(2), function(4)).
factClassCallsMethod(class(2), function(5)).
factClassCallsMethod(class(2), function(8)).
factClassCallsMethod(class(2), function(9)).
...
factClassRelatedMethod(class(2), function(9)).
factClassRelatedMethod(class(2), function(4)).
factClassRelatedMethod(class(2), function(5)).
factClassRelatedMethod(class(2), function(8)).
factClassRelatedMethod(class(2), function(9)).
...
factVFTableWrite(0x14018, function(4), vftable(1)).
% thisptr: ThisPtrVarOffset{func4, [], 32, $16, $22}
possibleVFTableWriteHelper(0x14018, function(4), thisptr(2), 0, vftable(1)).
...
factVBTableWrite(0x14007, function(4), vbtable(0)).
% thisptr: ThisPtrConstOffset{func4, [], 32, $3, 4}
possibleVBTableWriteHelper(0x14007, function(4), thisptr(4), 1, vbtable(0)).
...
factDerivedClass(class(2), class(1), 0x8, true).
factDerivedClass(class(2), class(1), 0x8).
factNOTEmbeddedObject(class(2), class(1), 0x8).
...
factClassSizeGTE(class(2), 0xc).
factClassSizeLTE(class(2), 0xc).
...
funcParameter(function(4), ecx, thisptr(7)).
% thisptr: GetArg{func4, [], 1, 1}
funcParameter(function(4), 1, thisptr(8)).
% thisptr: GetArg{func5, [], 32, 0}
funcParameter(function(5), ecx, thisptr(9)).
% thisptr: GetArg{func6, [], 32, 0}
funcParameter(function(6), ecx, thisptr(10)).
% thisptr: GetArg{func7, [], 32, 0}
funcParameter(function(7), ecx, thisptr(11)).
...
% thisptr: GetArg{func4, [], 32, 0}
callParameter(0x1400b, function(4), ecx, thisptr(7)).
% thisptr: GetArg{func4, [], 32, 0}
callParameter(0x1400e, function(4), ecx, thisptr(7)).
% thisptr: ThisPtrConstOffset{func5, [], 32, $16, -8}
callParameter(0x15013, function(5), ecx, thisptr(14)).
% thisptr: ThisPtrConstOffset{func8, [], 32, $1, 8}
callParameter(0x18004, function(8), ecx, thisptr(15)).
% thisptr: GetArg{func8, [], 32, 0}
callParameter(0x18009, function(8), ecx, thisptr(12)).
callTarget(0x1400b, function(4), function(3)).
callTarget(0x1400e, function(4), function(1)).
callTarget(0x15013, function(5), function(0)).
callTarget(0x18004, function(8), function(5)).
callTarget(0x18009, function(8), function(2)).
thisPtrOffset(function(4), thisptr(7), 0x4, thisptr(4)).
thisPtrOffset(function(4), thisptr(7), 0x8, thisptr(16)).
thisPtrOffset(function(4), thisptr(7), 0x4, thisptr(4)).
thisPtrOffset(function(4), thisptr(17), 0x4, thisptr(18)).
thisPtrOffset(function(5), thisptr(9), -0x8, thisptr(14)).
thisPtrOffset(function(5), thisptr(9), -0x8, thisptr(14)).
thisPtrOffset(function(5), thisptr(14), 0x4, thisptr(19)).
thisPtrOffset(function(5), thisptr(20), 0x4, thisptr(21)).
thisPtrOffset(function(5), thisptr(9), -0x8, thisptr(14)).
thisPtrOffset(function(8), thisptr(12), 0x8, thisptr(15)).
thisPtrOffset(function(8), thisptr(12), 0x8, thisptr(15)).
