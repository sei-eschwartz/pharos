...
factClassCallsMethod(class(0), function(5)).
factClassCallsMethod(class(0), function(0)).
factClassCallsMethod(class(0), function(1)).
factClassCallsMethod(class(0), function(5)).
factClassCallsMethod(class(0), function(0)).
...
factVFTableWrite(0x12013, function(2), vftable(2)).
% thisptr: ThisPtrConstOffset{func2, [], 32, $14, -8}
possibleVFTableWriteHelper(0x12013, function(2), thisptr(3), 0, vftable(2)).
factVFTableWrite(0x14015, function(4), vftable(1)).
% thisptr: ThisPtrVarOffset{func4, [], 32, $13, $19}
possibleVFTableWriteHelper(0x14015, function(4), thisptr(4), 0, vftable(1)).
factVFTableWrite(0x1401a, function(4), vftable(2)).
% thisptr: GetArg{func4, [], 32, 0}
possibleVFTableWriteHelper(0x1401a, function(4), thisptr(5), 0, vftable(2)).
factVFTableWrite(0x1600f, function(6), vftable(0)).
% thisptr: ThisPtrConstOffset{func6, [nullptr, nullptr], 32, $7, 8}
possibleVFTableWriteHelper(0x1600f, function(6), thisptr(6), 1, vftable(0)).
factVBTableWrite(0x14007, function(4), vbtable(0)).
% thisptr: ThisPtrConstOffset{func4, [], 32, $3, 4}
possibleVBTableWriteHelper(0x14007, function(4), thisptr(7), 1, vbtable(0)).
...
findint(function(5), class(0)).
factMethod(function(5)).
factDeletingDestructor(function(5)).
...
funcParameter(function(2), ecx, thisptr(8)).
% thisptr: GetArg{func3, [], 32, 0}
funcParameter(function(3), ecx, thisptr(9)).
% thisptr: GetArg{func4, [], 32, 0}
funcParameter(function(4), ecx, thisptr(5)).
...
% thisptr: ThisPtrConstOffset{func4, [], 32, $9, 8}
callParameter(0x1400b, function(4), ecx, thisptr(14)).
% thisptr: ThisPtrConstOffset{func6, [], 32, $1, 8}
callParameter(0x16004, function(6), ecx, thisptr(15)).
callTarget(0x1400b, function(4), function(1)).
callTarget(0x16004, function(6), function(2)).
thisPtrOffset(function(2), thisptr(8), -0x8, thisptr(3)).
thisPtrOffset(function(2), thisptr(8), -0x8, thisptr(3)).
thisPtrOffset(function(2), thisptr(3), 0x4, thisptr(16)).
thisPtrOffset(function(2), thisptr(17), 0x4, thisptr(18)).
thisPtrOffset(function(2), thisptr(8), -0x8, thisptr(3)).
thisPtrOffset(function(2), thisptr(8), -0x8, thisptr(3)).
thisPtrOffset(function(4), thisptr(5), 0x4, thisptr(7)).
thisPtrOffset(function(4), thisptr(5), 0x8, thisptr(14)).
thisPtrOffset(function(4), thisptr(5), 0x4, thisptr(7)).
thisPtrOffset(function(4), thisptr(19), 0x4, thisptr(20)).
thisPtrOffset(function(6), thisptr(12), 0x8, thisptr(15)).
thisPtrOffset(function(6), thisptr(12), 0x8, thisptr(6)).
thisPtrOffset(function(6), thisptr(12), 0x8, thisptr(6)).
thisPtrOffset(function(6), thisptr(12), 0x8, thisptr(6)).
...
groundVFTableBelongsToClass(vftable(2), class(1)).
findint(vftable(2), class(1)).
