...
factClassCallsMethod(class(0), function(8)).
factClassCallsMethod(class(0), function(0)).
factClassCallsMethod(class(0), function(1)).
factClassCallsMethod(class(0), function(2)).
factClassCallsMethod(class(0), function(3)).
...
factClassCallsMethod(class(1), function(8)).
factClassCallsMethod(class(1), function(0)).
factClassCallsMethod(class(1), function(1)).
factClassCallsMethod(class(1), function(2)).
factClassCallsMethod(class(1), function(3)).
...
factClassCallsMethod(class(1), function(9)).
factClassCallsMethod(class(1), function(10)).
factClassCallsMethod(class(1), function(4)).
factClassCallsMethod(class(1), function(5)).
factClassCallsMethod(class(1), function(9)).
factClassCallsMethod(class(1), function(10)).
...
factClassRelatedMethod(class(1), function(8)).
...
possibleVFTableWriteHelper(0x12005, function(2), thisptr(0), 0, vftable(0)).
...
% thisptr: ThisPtrVarOffset{func4, [], 32, $12, $18}
possibleVFTableWriteHelper(0x14014, function(4), thisptr(2), 0, vftable(1)).
factVFTableWrite(0x1500c, function(5), vftable(1)).
% thisptr: ThisPtrVarOffset{func5, [], 32, $4, $10}
possibleVFTableWriteHelper(0x1500c, function(5), thisptr(3), 0, vftable(1)).
factVFTableWrite(0x16005, function(6), vftable(2)).
% thisptr: GetArg{func6, [], 32, 0}
possibleVFTableWriteHelper(0x16005, function(6), thisptr(4), 0, vftable(2)).
factVFTableWrite(0x17008, function(7), vftable(2)).
% thisptr: GetArg{func7, [], 32, 0}
possibleVFTableWriteHelper(0x17008, function(7), thisptr(5), 0, vftable(2)).
factVBTableWrite(0x14006, function(4), vbtable(0)).
% thisptr: GetArg{func4, [], 32, 0}
possibleVBTableWriteHelper(0x14006, function(4), thisptr(6), 1, vbtable(0)).
factDerivedClass(class(1), class(0), 0x4, true).
factDerivedClass(class(1), class(0), 0x4).
...
factEmbeddedObject(class(2), class(1), 0x8).
factNOTDerivedClass(class(2), class(1), 0x8).
factObjectInObject(class(2), class(1), 0x8).
factClassHasNoBase(class(0)).
factClassSizeGTE(class(0), 0x8).
factClassSizeLTE(class(0), 0x8).
factClassSizeGTE(class(1), 0xc).
factClassSizeLTE(class(1), 0xc).
factClassSizeGTE(class(2), 0x14).
factClassSizeLTE(class(2), 0x14).
...
funcParameter(function(0), ecx, thisptr(7)).
% thisptr: GetArg{func0, [], 32, 1}
funcParameter(function(0), 1, thisptr(8)).
% thisptr: GetArg{func1, [], 32, 0}
funcParameter(function(1), ecx, thisptr(9)).
% thisptr: GetArg{func2, [], 32, 0}
funcParameter(function(2), ecx, thisptr(0)).
% thisptr: GetArg{func3, [], 32, 0}
funcParameter(function(3), ecx, thisptr(1)).
% thisptr: GetArg{func4, [], 32, 0}
funcParameter(function(4), ecx, thisptr(6)).
% thisptr: GetArg{func4, [], 1, 1}
funcParameter(function(4), 1, thisptr(10)).
% thisptr: GetArg{func5, [], 32, 0}
funcParameter(function(5), ecx, thisptr(11)).
% thisptr: GetArg{func6, [], 32, 0}
funcParameter(function(6), ecx, thisptr(4)).
% thisptr: GetArg{func7, [], 32, 0}
funcParameter(function(7), ecx, thisptr(5)).
% thisptr: GetArg{func8, [], 32, 0}
funcParameter(function(8), ecx, thisptr(12)).
% thisptr: GetArg{func9, [], 32, 0}
funcParameter(function(9), ecx, thisptr(13)).
% thisptr: GetArg{func10, [], 32, 0}
funcParameter(function(10), ecx, thisptr(14)).
% thisptr: GetArg{func11, [], 32, 0}
funcParameter(function(11), ecx, thisptr(15)).
% thisptr: ThisPtrConstOffset{func4, [], 32, $8, 4}
callParameter(0x1400a, function(4), ecx, thisptr(16)).
% thisptr: ThisPtrConstOffset{func6, [], 32, $11, 4}
callParameter(0x1600f, function(6), ecx, thisptr(17)).
% thisptr: GetArg{func6, [], 32, 0}
callParameter(0x16012, function(6), ecx, thisptr(4)).
% thisptr: GetArg{func7, [], 32, 0}
callParameter(0x17003, function(7), ecx, thisptr(5)).
% thisptr: ThisPtrConstOffset{func7, [], 32, $11, 8}
callParameter(0x1700d, function(7), ecx, thisptr(18)).
% thisptr: LiteralBool{func7, [], 1, 0}
callParameter(0x1700d, function(7), 1, thisptr(19)).
% thisptr: ThisPtrConstOffset{func9, [], 32, $1, 4}
callParameter(0x19004, function(9), ecx, thisptr(20)).
% thisptr: ThisPtrConstOffset{func9, [], 32, $7, 4}
callParameter(0x19009, function(9), ecx, thisptr(20)).
callTarget(0x1400a, function(4), function(2)).
callTarget(0x1600f, function(6), function(5)).
callTarget(0x16012, function(6), function(3)).
callTarget(0x17003, function(7), function(2)).
callTarget(0x1700d, function(7), function(4)).
callTarget(0x19004, function(9), function(5)).
callTarget(0x19009, function(9), function(3)).
thisPtrOffset(function(4), thisptr(6), 0x4, thisptr(16)).
thisPtrOffset(function(4), thisptr(6), 0, thisptr(21)).
thisPtrOffset(function(4), thisptr(22), 0x4, thisptr(23)).
thisPtrOffset(function(5), thisptr(11), -0x4, thisptr(24)).
thisPtrOffset(function(5), thisptr(11), -0x4, thisptr(24)).
thisPtrOffset(function(5), thisptr(24), 0, thisptr(25)).
thisPtrOffset(function(5), thisptr(26), 0x4, thisptr(27)).
thisPtrOffset(function(6), thisptr(4), 0x8, thisptr(28)).
thisPtrOffset(function(6), thisptr(4), 0x4, thisptr(17)).
thisPtrOffset(function(7), thisptr(5), 0x8, thisptr(18)).
thisPtrOffset(function(9), thisptr(13), 0x4, thisptr(20)).
thisPtrOffset(function(9), thisptr(13), 0x4, thisptr(20)).
