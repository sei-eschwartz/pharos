...
% MSVC: offset from vbptr for vbtable(0) to start of class 1 is 0
factVBTableEntry(vbtable(0), 0, 0).
% class 0 offset 4
factVBTableEntry(vbtable(0), 4, 0x4).
% vbtable(1) for path [ 1, 2 ]
factVBTable(vbtable(1)).
% MSVC: offset from vbptr for vbtable(1) to start of class 2 is 0
factVBTableEntry(vbtable(1), 0, 0).
% class 0 offset 4
factVBTableEntry(vbtable(1), 4, 0x4).
% vftable(0) for path [ 2 ]
...
factVFTableWrite(0x13015, function(3), vftable(0)).
possibleVFTableWriteHelper(0x13015, function(3), thisptr(0), [], vftable(0)).
factVBTableWrite(0x11006, function(1), vbtable(0)).
possibleVBTableWriteHelper(0x11006, function(1), thisptr(1), [conditional], vbtable(0)).
factVBTableWrite(0x13007, function(3), vbtable(1)).
possibleVBTableWriteHelper(0x13007, function(3), thisptr(2), [conditional], vbtable(1)).
...
factDerivedClass(class(2), class(1), 0x4, nonvirtual).
factDerivedClass(class(2), class(1), 0x4, unknown).
factNOTEmbeddedObject(class(2), class(1), 0x4).
factObjectInObject(class(2), class(1), 0x4).
factDerivedClass(class(2), class(0), 0x8, virtual).
factDerivedClass(class(2), class(0), 0x8, unknown).
factNOTEmbeddedObject(class(2), class(0), 0x8).
factObjectInObject(class(2), class(0), 0x8).
...
findint(function(3), class(2)).
factMethod(function(3)).
factConstructor(function(3)).
factNOTRealDestructor(function(3)).
factNOTDeletingDestructor(function(3)).
funcParameter(function(0), ecx, thisptr(3)).
funcParameter(function(1), ecx, thisptr(1)).
funcParameter(function(1), 1, thisptr(4)).
funcParameter(function(2), ecx, thisptr(5)).
funcParameter(function(3), ecx, thisptr(0)).
funcParameter(function(3), 1, thisptr(6)).
callParameter(0x1100a, function(1), ecx, thisptr(7)).
callParameter(0x1300b, function(3), ecx, thisptr(8)).
callParameter(0x13010, function(3), ecx, thisptr(2)).
callParameter(0x13010, function(3), 1, thisptr(9)).
callTarget(0x1100a, function(1), function(0)).
callTarget(0x1300b, function(3), function(0)).
callTarget(0x13010, function(3), function(1)).
thisPtrOffset(function(1), thisptr(1), 0x4, thisptr(7)).
thisPtrOffset(function(3), thisptr(0), 0x4, thisptr(2)).
thisPtrOffset(function(3), thisptr(0), 0x8, thisptr(8)).
thisPtrOffset(function(3), thisptr(0), 0x4, thisptr(2)).
...
groundVFTableBelongsToClass(vftable(0), class(2)).
findint(vftable(0), class(2)).
